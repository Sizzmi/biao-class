        ...
        <div class="col-lg-9">
          <div class="content card">
            ...
            <div class="tool-bar">
              ...
              <!--<form @submit="search_by_vehicle($event)">-->
              <!--<input type="search" v-model="vehicle_keyword"-->
            ...
            <form v-if="show_form" @submit="cou($event)">
              ...
              <div class="input-control">
                <div class="btn-group">
                  <button :disabled="!current.vehicle_id" class="btn-primary" type="submit">提交</button>
...
<script>
  ...
  export default {
    mounted () {
      // api('captcha/captcha', { phone : 18392485904 });
      // api('captcha/mail', { email : 'biaoyansu@gmail.com' });
      this.read();
      this.get_structure();
    },
    components : { Dropdown },
