var config
  ...
  , el_pagination_list//用于渲染页码的元素（由于还有“上一页”，“下一页”的存在，为了清楚，将所有数字页码封装到一个元素中）
...
el.addEventListener('click', function (e) {
  var target = e.target//谁冒的泡
    ...
    , last = target.classList.contains('pagination-last')//点击了最后一页
